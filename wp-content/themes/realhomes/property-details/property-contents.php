<article class="property-item clearfix">
    ...
    <div class="content clearfix">
        ...
        $ganado_padre = get_post_meta($post->ID,'REAL_HOMES_ganado_padre',true);
        $ganado_madre = get_post_meta($post->ID,'REAL_HOMES_ganado_madre',true);
        
        if( !empty($ganado_padre) || !empty($ganado_madre)){
            echo '<h4 class="additional-title">Detalle</h4>';
            if( !empty($ganado_madre) ){
                echo '<ul class="additional-details clearfix">';
                echo '<li><strong>Madre:</strong>';
                echo '<span>'.$ganado_madre.'</span></li></ul>';
            }
            if( !empty($ganado_padre) ){
                echo '<ul class="additional-details clearfix">';
                echo '<li><strong>Padre:</strong>';
                echo '<span>'.$ganado_padre.'</span></li></ul>';
            }
            echo '</br></br>';
        }
