                ...
                <div class="main">
                    ...
                    <section class="property-items">
                        ...
                        <div class="property-items-container clearfix">
                            ...
                            $postIDCurrent = get_the_ID();
                            $type_terms = get_the_terms( $postIDCurrent,"property-type" );
                            if(!empty($type_terms)){
                                $index = 0;
                                foreach($type_terms as $typ_trm){
                                    $types_asd[$index] = $typ_trm->slug;
                                    $index++;
                                    //break;
                                }
                            ...
                            if ( $home_properties_query->have_posts() ) :
                                ...
                                <div class="alert-wrapper">
                                    <h4>No existen anuncios en esta Categoría</h4>
                                </div>
                                <?php
                            endif;
                            ?>
...
<?php if( is_front_page() || is_home() || is_404() ) {
                if(function_exists('drawAdsPlace'))
                        drawAdsPlace(array('id' => 1), array('before' => '<div class="ad">', 'after' => '</div>'));
        }
?>
