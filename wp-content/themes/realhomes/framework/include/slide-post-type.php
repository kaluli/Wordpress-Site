...
if( !function_exists( 'create_slide_post_type' ) ){
    function create_slide_post_type(){
        $labels = array(
            'name' => __( 'Banners','framework'),
            'singular_name' => __( 'Banner','framework' ),
            ...
            'search_items' => __('Search Banner','framework'),
            'not_found' =>  __('No Banner found','framework'),
            'not_found_in_trash' => __('No Banner found in Trash','framework'),
            'parent_item_colon' => ''
          );
