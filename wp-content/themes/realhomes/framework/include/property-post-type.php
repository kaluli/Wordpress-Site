...
if( !function_exists( 'create_property_post_type' ) ){
    function create_property_post_type(){
      ...
      $labels = array(
            'name' => __( 'Anuncios','framework'),
            'singular_name' => __( 'Anuncio','framework' ),
            'add_new' => __('Add New','framework'),
            'add_new_item' => __('Add New Anuncio','framework'),
            'edit_item' => __('Edit Anuncio','framework'),
            'new_item' => __('New Anuncio','framework'),
            'view_item' => __('View Anuncio','framework'),
            'search_items' => __('Search Anuncio','framework'),
            'not_found' =>  __('No Anuncio found','framework'),
            'not_found_in_trash' => __('No Anuncio found in Trash','framework'),
            'parent_item_colon' => ''
          );
...
if( !function_exists( 'build_taxonomies' ) ){
    function build_taxonomies(){
        ...
        $type_labels = array(
            'name' => __( 'Tipo de Anuncio', 'framework' ),
            'singular_name' => __( 'Tipo de Anuncio', 'framework' ),
            'search_items' =>  __( 'Search Tipo Anuncio', 'framework' ),
            'popular_items' => __( 'Popular Tipo Anuncio', 'framework' ),
            'all_items' => __( 'All Anuncio Tipo', 'framework' ),
            'parent_item' => __( 'Parent Anuncio Tipo', 'framework' ),
            'parent_item_colon' => __( 'Parent Tipo Anuncio:', 'framework' ),
            'edit_item' => __( 'Edit Tipo Anuncio', 'framework' ),
            'update_item' => __( 'Update Tipo Anuncio', 'framework' ),
            'add_new_item' => __( 'Add New Tipo Anuncio', 'framework' ),
            'new_item_name' => __( 'New Tipo Anuncio Name', 'framework' ),
            'separate_items_with_commas' => __( 'Separate Tipo Anuncio with commas', 'framework' ),
            'add_or_remove_items' => __( 'Add or remove Tipo Anuncio', 'framework' ),
            'choose_from_most_used' => __( 'Choose from the most used Tipo Anuncio', 'framework' ),
            'menu_name' => __( 'Tipo Anuncio', 'framework' )
        );
