...
if( !function_exists( 'create_partners_post_type' ) ){
    function create_partners_post_type(){
      ...
      $labels = array(
        'name' => __( 'Criaderos','framework'),
        'singular_name' => __( 'Criaderos','framework' ),
        'add_new' => __('Add New','framework'),
        'add_new_item' => __('Add New Criaderos','framework'),
        'edit_item' => __('Edit Criaderos','framework'),
        'new_item' => __('New Criaderos','framework'),
        'view_item' => __('View Criaderos','framework'),
        'search_items' => __('Search Criaderos','framework'),
        'not_found' =>  __('No Criaderos found','framework'),
        'not_found_in_trash' => __('No Criaderos found in Trash','framework'),
        'parent_item_colon' => ''
      );
