...
<div class="as-form-wrap">
    ...
    <div class="option-bar large">
            <label for="text_search-txt">Ingresa tu búsqueda</label>
            <input type="text" name="text_search" id="text_search-txt" value="<?php echo isset($_GET['text_search'])?$_GET['text_search']:''; ?>" placeholder="" />
        </div>
