                ...
                if( isset($_POST['item_number']) && (!empty($_POST['item_number'])) ){
                    ...
                    if( $property ){
                        ...
                        if( isset($_POST['txn_id']) && (!empty($_POST['txn_id'])) ){
                            update_post_meta( $property_id, 'txn_id', $_POST['txn_id'] );
                        }
                        if( isset($_POST['payment_date']) && (!empty($_POST['payment_date'])) ){
                            update_post_meta( $property_id, 'payment_date', $_POST['payment_date'] );
                        }
                        if( isset($_POST['payer_email']) && (!empty($_POST['payer_email'])) ){
                            update_post_meta( $property_id, 'payer_email', $_POST['payer_email'] );
                        }
                        if( isset($_POST['first_name']) && (!empty($_POST['first_name'])) ){
                            update_post_meta( $property_id, 'first_name', $_POST['first_name'] );
                        }
                        if( isset($_POST['last_name']) && (!empty($_POST['last_name'])) ){
                            update_post_meta( $property_id, 'last_name', $_POST['last_name'] );
                        }
                        if( isset($_POST['payment_status']) && (!empty($_POST['payment_status'])) ){
                            update_post_meta( $property_id, 'payment_status', $_POST['payment_status'] );
                        }
                        if( isset($_POST['payment_gross']) && (!empty($_POST['payment_gross'])) ){
                            update_post_meta( $property_id, 'payment_gross', $_POST['payment_gross'] );
                        }
                        if( isset($_POST['mc_currency']) && (!empty($_POST['mc_currency'])) ){
                            update_post_meta( $property_id, 'mc_currency', $_POST['mc_currency'] );
                        }
                        ...
                        error_log( "Target property id do not reside in database." );
                    }
