...
<table class="form-table">
	...
	<tr valign="top">
		<th scope="row"><label for="encode_url"><?php _e('URL Encoding','userpro'); ?></label></th>
		<td>
			<select name="encode_url" id="encode_url" class="chosen-select" style="width:300px">
				<option value="1" <?php selected('1', userpro_get_option('encode_url')); ?>><?php _e('Activate','userpro'); ?></option>
				<option value="0" <?php selected('0', userpro_get_option('encode_url')); ?>><?php _e('Disable','userpro'); ?></option>
			</select>
			<span class="description"><?php _e('If you use CDN or have a problem with thumbnails, try switching this option.','userpro'); ?></span>
		</td>
	</tr>
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If this is set to yet, author archives will be redirected to author profile pages automatically.','userpro'); ?></span>
		</td>
	</tr>
