	...
	?>
			<div class="userpro-admin-head">
				...
				<div class="userpro-admin-right">
					...
					<a href="https://twitter.com/UserProPlugin/with_replies" class="button"><?php _e('Twitter Support','userpro'); ?></a>
					<a href="http://userproplugin.com/userpro/customer_portal/" class="button button-primary"><?php _e('Download Latest','userpro'); ?></a>
				</div>
				<div class="clear"></div>
			</div>
	<?php
