...
<?php $emd_state = (int) $userpro_emd->yes_show_filters( $args );
if ($emd_state == 1) { ?>
<div class="emd-filters">
...
<div class="emd-main emd-main-<?php echo $emd_state; ?>">
	...
	<?php if (isset($arr['paginate']) && $emd_paginate && $emd_paginate_top == 1) { ?><div class="userpro-paginate top"><?php echo $arr['paginate']; ?></div><?php } ?>
		
	<div class="emd-list" data-layoutmode="<?php echo $emd_layout; ?>">
		...
		<div class="emd-user">
			...
			<div class="emd-user-img">
				<a href="<?php echo $userpro->permalink( $user_id ); ?>"><?php echo get_avatar( $user_id, $emd_thumb ); ?></a>
			</div>
			...
			<?php if ($emd_fields) { $array = explode(',',$emd_fields); ?>
	...
	<?php if (isset($arr['paginate']) && $emd_paginate ) { ?><div class="userpro-paginate bottom"><?php echo $arr['paginate']; ?></div><?php } ?>
