	...
	function userpro_post_editor($i, $class, $args) {
		...
		?>
			<div class="userpro-field userpro-field-editor" data-key="<?php echo $class; ?>">
				...
				<?php
					echo "<textarea data-custom-error='".__('Provide some content','userpro')."' data-required='".$args['require_content']."' class='normal' type='text' name='$class-$i' id='$class-$i' placeholder='".__('Enter content here...','userpro')."'></textarea>";
				?>
				</div>
